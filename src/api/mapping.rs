...
pub async fn save_mapping(
    ...
    let insert_result = sqlx::query_as::<_, SemanticMapping>(
        r#"
        INSERT INTO semantic_mappings (entity_key, entity_label, alias_names, target_table, target_column)
        VALUES ($1, $2, $3, $4, $5)
        ...
        RETURNING id, entity_key, entity_label, alias_names, target_table, target_column
        "#
    )
